...
Write-Host "`n[1/5] Copying SQL files to container..." -ForegroundColor Yellow
...
Write-Host "`n[2/5] Dropping all tables..." -ForegroundColor Yellow
...
Write-Host "`n[3/5] Creating table structure..." -ForegroundColor Yellow
...
Write-Host "`n[4/5] Initializing dictionary data..." -ForegroundColor Yellow
...
Write-Host "`n[5/5] Fixing constraints and indexes..." -ForegroundColor Yellow
