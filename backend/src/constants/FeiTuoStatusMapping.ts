 ...
 * 用于飞驼数据的统计和筛选
 */
export const FEITUO_STATUS_TYPE_MAP: Record<
  string,
  'ETA' | 'ATA' | 'GATE_IN' | 'GATE_OUT' | 'DISCHARGED' | 'AVAILABLE' | 'STATUS'
> = {
  ETA: 'ETA',
  ARRIVE: 'ATA',
  ATA: 'ATA',
 ...
 */
export const getPortTypeForStatusCode = (
  statusCode: string
 ...
 */
export const getStatusTypeForStatusCode = (
  statusCode: string
): 'ETA' | 'ATA' | 'GATE_IN' | 'GATE_OUT' | 'DISCHARGED' | 'AVAILABLE' | 'STATUS' => {
