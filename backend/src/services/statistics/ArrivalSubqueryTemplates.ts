...
export class ArrivalSubqueryTemplates {
  ...
  /**
   * 中转港3天内到港子查询模板
   * 条件：目的港无ATA + 有ETA + 今日≤ETA≤3天 + 有中转港记录
   */
  ...
  /**
   * 中转港7天内到港子查询模板
   * 条件：目的港无ATA + 有ETA + 3天<ETA≤7天 + 有中转港记录
   */
