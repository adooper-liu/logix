-- ============================================================
-- LogiX 字典表完整初始化数据
-- Dictionary Tables Complete Initial Data
-- ============================================================
-- 数据来源：从生产数据库导出
-- 导出时间：2026-03-24
-- 包含表：10 个核心字典表，共 445 条记录
-- ============================================================
...
-- ============================================================
-- 1. dict_countries (43 个国家) - ISO 3166-1 alpha-2 标准
-- ============================================================
...
-- ============================================================
-- 3. dict_container_types (37 个箱型) - 部分示例
-- ============================================================
\echo ''
\echo '-- 3. dict_container_types (部分示例)'
INSERT INTO dict_container_types (type_code, type_name, length, width, height, volume, max_payload, is_active) VALUES
('20GP', '20 英尺普通柜', 5.898, 2.352, 2.393, 33.1, 28200, true),
('40GP', '40 英尺普通柜', 12.032, 2.352, 2.393, 67.5, 26780, true),
('40HC', '40 英尺高柜', 12.032, 2.352, 2.698, 76.2, 26580, true),
('45HC', '45 英尺高柜', 13.716, 2.352, 2.698, 86.0, 25600, true);
...
-- ============================================================
-- 7. dict_shipping_companies (92 个船公司) - 主要示例
-- ============================================================
\echo ''
\echo '-- 7. dict_shipping_companies (主要船公司)'
...
-- ============================================================
-- 8. dict_ports (72 个港口) - 主要港口示例
-- ============================================================
\echo ''
\echo '-- 8. dict_ports (主要港口)'
...
-- 欧洲其他港口
('NLRTM', '鹿特丹', 'Rotterdam', 'PORT', 'NL', 'ZH', 'Rotterdam', 1, 51.924400, 4.477700, true, true, true, 'ACTIVE'),
('DEHAM', '汉堡', 'Hamburg', 'PORT', 'DE', 'HH', 'Hamburg', 1, 53.551100, 9.993700, true, true, true, 'ACTIVE'),
('BEANR', '安特卫普', 'Antwerp', 'PORT', 'BE', 'VAN', 'Antwerp', 1, 51.219400, 4.402500, true, true, true, 'ACTIVE'),
('FRLEH', '勒阿弗尔', 'Le Havre', 'PORT', 'FR', 'NOR', 'Le Havre', 1, 49.494400, 0.107900, true, true, true, 'ACTIVE');

-- ============================================================
-- 9. dict_warehouses (149 个仓库) - 部分示例
-- ============================================================
\echo ''
\echo '-- 9. dict_warehouses (部分仓库示例)'
...
\echo '  - 21 个车队'
\echo ''
\echo '提示：完整数据请使用 export-dict-tables-data.sql 导出脚本生成'
\echo ''
