...
> 💡 **提示**: 本技能与 `logix-development` 技能配合使用。完整开发规范请参考主技能文档。

## Quick Start

When reviewing code, verify against:

1. LogiX development standards (`.cursor/rules/logix-development-standards.mdc`)
2. Project map (`.cursor/rules/logix-project-map.mdc`)
3. This checklist
