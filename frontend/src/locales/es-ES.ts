...
export default {
  ...
  nav: {
    ...
    dictManage: 'Gestión de diccionarios',
    demurrageStandardsImport: 'Importar estándares',
    warehouseTruckingMapping: 'Mapeo almacén-transporte',
    truckingPortMapping: 'Mapeo transporte-puerto',
