...
export default {
  ...
  nav: {
    ...
    dictManage: 'Gestione dizionari',
    demurrageStandardsImport: 'Importa standard',
    warehouseTruckingMapping: 'Mappatura magazzino-trasporto',
    truckingPortMapping: 'Mappatura trasporto-porto',
