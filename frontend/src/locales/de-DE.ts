...
export default {
  ...
  nav: {
    ...
    dictManage: 'Wörterbuchverwaltung',
    demurrageStandardsImport: 'Standards importieren',
    warehouseTruckingMapping: 'Lager-Transport-Zuordnung',
    truckingPortMapping: 'Transport-Hafen-Zuordnung',
