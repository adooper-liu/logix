 ...
 */
export const SimplifiedStatusType: Record<
  SimplifiedStatus,
 ...
 */
export const getLogisticsStatusClass = (status: SimplifiedStatus | string): string => {
...
export const SimplifiedStatusTransitions: Record<SimplifiedStatus, SimplifiedStatus[]> = {
  ...
  [SimplifiedStatus.IN_TRANSIT]: [SimplifiedStatus.AT_PORT, SimplifiedStatus.PICKED_UP],
  [SimplifiedStatus.AT_PORT]: [SimplifiedStatus.PICKED_UP, SimplifiedStatus.UNLOADED],
  [SimplifiedStatus.PICKED_UP]: [SimplifiedStatus.UNLOADED, SimplifiedStatus.RETURNED_EMPTY],
