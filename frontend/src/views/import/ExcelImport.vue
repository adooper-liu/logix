...
const FIELD_MAPPINGS: FieldMapping[] = [
  ...
  { excelField: '出运日期', table: 'biz_replenishment_orders', field: 'expected_ship_date', required: false, transform: parseDate },
  { excelField: '实际装船时间', table: 'process_sea_freight', field: 'actual_loading_date', required: false, transform: parseDate },
