...
describe('logisticsStatusMachine', () => {
  ...
  describe('isValidSimplifiedTransition', () => {
    it('should return true for valid transitions', () => {
      expect(isValidSimplifiedTransition(SimplifiedStatus.NOT_SHIPPED, SimplifiedStatus.SHIPPED)).toBe(true);
      expect(isValidSimplifiedTransition(SimplifiedStatus.SHIPPED, SimplifiedStatus.IN_TRANSIT)).toBe(true);
    });

    it('should return false for invalid transitions', () => {
      expect(isValidSimplifiedTransition(SimplifiedStatus.NOT_SHIPPED, SimplifiedStatus.RETURNED_EMPTY)).toBe(false);
    });
  });
