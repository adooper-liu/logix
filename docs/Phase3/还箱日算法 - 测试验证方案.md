...
describe("IntelligentSchedulingService - Return Date Calculation", () => {
  ...
  describe("Drop off Mode - Three-Step Priority", () => {
    it("Step 1: 卸柜日当天有能力，应返回当天还箱", async () => {
      ...
      // Act
      const result = await (service as any).calculatePlannedReturnDate(unloadDate, "Drop off", truckingCompanyId);
  ...
  describe("Live Load Mode", () => {
    it("能力充足，应返回还=卸，不调整卸柜日", async () => {
      ...
      // Act
      const result = await (service as any).calculatePlannedReturnDate(unloadDate, "Live load", truckingCompanyId);
  ...
  describe("Last Return Date Constraint", () => {
    it("在 lastReturnDate 前找到有能力日期，应返回该日期", async () => {
      ...
      // Act
      const result = await (service as any).calculatePlannedReturnDate(unloadDate, "Drop off", truckingCompanyId, lastReturnDate);
