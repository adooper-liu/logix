  ...
  <el-table :data="containers">
    ...
    <el-table-column label="优化">
      <template #default="{ row }">
        <el-button @click="handleOptimize(row)" :loading="optimizing.includes(row.containerNumber)"> 优化方案 </el-button>
      </template>
    </el-table-column>
  </el-table>

  <!-- 集成优化面板 -->
  <CostOptimizationPanel v-model:visible="showOptimization" :container="selectedContainer" @apply="handleApplyOptimization" />
</template>
```
